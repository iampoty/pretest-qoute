        ...
        <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <div className="overflow-x-auto">
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr className="border-b dark:border-gray-700" key="imac-27">
                            ...
                            <td className="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="apple-imac-27-dropdown" className="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" aria-labelledby="apple-imac-27-dropdown-button">
                        ...
                        <tr className="border-b dark:border-gray-700" key="imac-20">
                        ...
                        <tr className="border-b dark:border-gray-700" key="iphone-14">
                        ...
                        <tr className="border-b dark:border-gray-700" key="num-01">
                        ...
                        <tr className="border-b dark:border-gray-700" key="num-02">
                        ...
                        <tr className="border-b dark:border-gray-700" key="num-03">
                        ...
                        <tr className="border-b dark:border-gray-700" key="num-04">
                        ...
                        <tr className="border-b dark:border-gray-700" key="num-05">
                        ...
                        <tr className="border-b dark:border-gray-700" key="num-06">
                        ...
                        <tr className="border-b dark:border-gray-700" key="num-07">
